...
switch ($current_role) {
    case 'admin':
        ...
        $menus = [
            ...
            ['label' => 'Persuratan', 'url' => 'persuratan.php', 'icon' => 'bi-envelope'],
            ['label' => 'Absensi', 'url' => 'absensi.php', 'icon' => 'bi-calendar-check'],
            ['label' => 'Cuti Karyawan', 'url' => 'cuti.php', 'icon' => 'bi-calendar-x'],
            ['label' => 'Transportasi', 'url' => 'transportasi.php', 'icon' => 'bi-truck'],
            ['label' => 'Sertifikat', 'url' => 'sertifikat.php', 'icon' => 'bi-award'],
    ...
    case 'ahlik3':
        ...
        $menus = [
            ['label' => 'Dashboard', 'url' => 'dashboard.php', 'icon' => 'bi-speedometer2'],
            ['label' => 'Jadwal K3', 'url' => 'jadwal.php', 'icon' => 'bi-calendar-event'],
    ...
    case 'client':
        ...
        $menus = [
            ['label' => 'Dashboard', 'url' => 'dashboard.php', 'icon' => 'bi-speedometer2'],
            ['label' => 'Pengajuan Layanan', 'url' => 'pengajuan.php', 'icon' => 'bi-file-earmark-plus'],
            ['label' => 'Status Pengajuan', 'url' => 'status.php', 'icon' => 'bi-hourglass-split'],
            ['label' => 'Riwayat Layanan', 'url' => 'riwayat.php', 'icon' => 'bi-clock-history'],
            ['label' => 'Dokumen Digital', 'url' => 'digital.php', 'icon' => 'bi-file-earmark-text'],
            ['label' => 'Notifikasi', 'url' => 'notifikasi.php', 'icon' => 'bi-bell'],
            ['label' => 'Profile', 'url' => 'profile.php', 'icon' => 'bi-person']
        ];
        break;
