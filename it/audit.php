<?php
// it/audit.php
$page_title = "System Audit Configuration";
...
<main class="main-content">
    <div class="card-box">
        ...
        <p class="text-secondary mb-0">Silakan kembangkan fungsionalitas halaman ini di file <code>it/audit.php</code> sesuai dengan kebutuhan modul.</p>
    </div>
</main>
