        ...
        <div class="arp-modal-body">
            <form method="POST" action="reimburse.php" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="upload-dropzone" id="dropzoneBuktiReimburseIt">
                        ...
                        <input type="file" name="lampiran_bukti" id="inputBuktiReimburseIt" class="d-none"
                            accept=".jpg,.jpeg,.png,.pdf" required>
                        <div class="upload-dropzone-filelist" id="fileListBuktiReimburseIt"></div>
                    </div>
                </div>
                <div class="mb-4">
