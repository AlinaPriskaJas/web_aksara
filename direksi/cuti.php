...
// Catatan: nilai 'terpakai' & 'sisa' di sini SELALU dibaca ulang dari database
// setiap kali halaman ini dimuat. Angkanya berubah otomatis begitu Direksi
// menyetujui pengajuan cuti tahunan di approval.php (lihat blok update
// Cuti_Saldo di direksi/approval.php) — tidak perlu ada logika tambahan
// di file ini untuk menghitungnya.
try {
