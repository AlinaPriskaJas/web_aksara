<?php
// direksi/reimburse.php
$page_title = "Reimburse Direksi";
...
<main class="main-content">
    <div class="card-box">
        ...
        <p class="text-secondary mb-0">Silakan kembangkan fungsionalitas halaman ini di file <code>direksi/reimburse.php</code> sesuai dengan kebutuhan modul.</p>
    </div>
</main>
