<?php
// client/status.php
$page_title = "Status Pengerjaan Proyek";
...
<main class="main-content">
    <div class="card-box">
        ...
        <p class="text-secondary mb-0">Silakan kembangkan fungsionalitas halaman ini di file <code>client/status.php</code> sesuai dengan kebutuhan modul.</p>
    </div>
</main>
